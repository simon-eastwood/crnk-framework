 ...
 */
@Component
public class DossierToDossierInfoRepositoryImpl extends RelationshipRepositoryBase<Dossier, String, DossierInfo, String> {

	public DossierToDossierInfoRepositoryImpl() {
		super(Dossier.class, DossierInfo.class);
	}
}
