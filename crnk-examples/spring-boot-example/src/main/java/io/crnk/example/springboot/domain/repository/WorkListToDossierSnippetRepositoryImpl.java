 ...
 */
@Component
public class WorkListToDossierSnippetRepositoryImpl extends RelationshipRepositoryBase<WorkList, String, DossierSnippet, String> {

	public WorkListToDossierSnippetRepositoryImpl() {
		super(WorkList.class, DossierSnippet.class);
	}
}
