 ...
 */
@Component
public class DossierInfoToDossierRepositoryImpl extends RelationshipRepositoryBase<DossierInfo, String, Dossier, String> {

	public DossierInfoToDossierRepositoryImpl() {
		super(DossierInfo.class, Dossier.class);
	}
}
